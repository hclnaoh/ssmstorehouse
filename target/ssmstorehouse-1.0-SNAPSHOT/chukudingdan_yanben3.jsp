...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  %>>
                             ...
                             <td>${u.dingdanbianhao}</td>    <td>${u.huowumingcheng}</td>    <td>${u.huowuleixing}</td>    <td>${u.kucun}</td>    <td>${u.jiage}</td>    <td>${u.goumaishuliang}</td>    <td>${u.jine}</td>    <td>${u.goumairen}</td>    
                              ...
                              <td height="50" align="center"> <a class="btn btn-info btn-small" href='dingdangenzong_add.jsp?id=${u.id}'>添加订单跟踪</a> <a class="btn btn-info btn-small" href="ckddDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
