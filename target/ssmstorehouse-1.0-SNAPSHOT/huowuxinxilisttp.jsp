...
<div class="in_about">
    <div class="container">
        ...
        <div class="in_aboutcon clearfix">
            ...
            <form action="hwxxListtp.do" name="myform" method="post" style="width:100%">
                ...
                <input type="submit" value="查询" class='hsgqiehuanshitu'/> <input type="button" name="Submit2"
                                                                                 ...
                                                                                 onClick="javascript:location.href='hwxxList.do';"/>
            </form>
            <br/>
                    ...
                    <c:forEach items="${list}" var="u">
                        ...
                        <td height="316" align="center">
                            <table height="285" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="250" align="center"><a href="hwxxDetail.do?id=${u.id}"><img
            ...
            <p align="center"><c:if test="${sessionScope.p==1}">
                <c:if test="${page.page>1}">
                    <a href="hwxxListtp.do?page=1">首页</a>
                    <a href="hwxxListtp.do?page=${page.page-1}"> 上一页</a> </c:if>
                <c:if test="${page.page<page.totalPage}">
                    <a href="hwxxListtp.do?page=${page.page+1}">下一页</a>
                    <a href="hwxxListtp.do?page=${page.totalPage}">末页</a> </c:if>
            </c:if>
            </p>
