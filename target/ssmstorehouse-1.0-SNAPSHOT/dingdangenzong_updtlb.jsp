	...
	<body>
			<form action="updateDingdangenzong.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">设置订单跟踪<input type="hidden" name="id" value="${dingdangenzong.id}" /></td>
						</tr>
		...
		<tr   style="display:none"><td width="200">购买数量：</td><td><input name='goumaishuliang' type='text' id='goumaishuliang' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		...
		<tr ><td width="200"><tr><td>订单状态：</td><td><select name='dingdanzhuangtai' id='dingdanzhuangtai' class="form-control"><option value="待确认">待确认</option><option value="待发货">待发货</option><option value="已发货">已发货</option></select></td></tr>
