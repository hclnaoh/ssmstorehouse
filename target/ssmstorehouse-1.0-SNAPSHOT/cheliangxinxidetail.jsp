...
<jsp:include page="qttop.jsp"></jsp:include>
 <div  class="in_about">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>车牌号：</td><td width='39%'>${cheliangxinxi.chepaihao}</td><td  rowspan=4 align=center><a href=${cheliangxinxi.tupian} target=_blank><img src=${cheliangxinxi.tupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>车辆品牌：</td><td width='39%'>${cheliangxinxi.cheliangpinpai}</td></tr><tr>         <td width='11%' height=44>车型：</td><td width='39%'>${cheliangxinxi.chexing}</td></tr><tr>         <td width='11%' height=44>状态：</td><td width='39%'>${cheliangxinxi.zhuangtai}</td></tr><tr>                           <td width='11%' height=100  >备注：</td><td width='39%' colspan=2 height=100 >${cheliangxinxi.beizhu}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("cheliangxinxi",id)){
	pli=pli+1;
     %>
                                   <tr>
