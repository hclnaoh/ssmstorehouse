...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">入库管理列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="rukuguanliList.do" name="myform" method="post">
  ...
  %>>
                             ...
                             <td>${u.huowubianhao}</td>    <td>${u.huowumingcheng}</td>    <td>${u.huowuleixing}</td>    <td>${u.kucun}</td>    <td>${u.rukushuliang}</td>    <td>${u.rukushijian}</td>        
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateRukuguanli.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteRukuguanli.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="rkglDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from rukuguanli where 1=1 ";
...
while(RS_result.next()){
		 ...
		 <c:if test="${page.page>1}">
              <a href="rukuguanliList.do?page=1" >首页</a>
             <a href="rukuguanliList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="rukuguanliList.do?page=${page.page+1 }">下一页</a>
			<a href="rukuguanliList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
