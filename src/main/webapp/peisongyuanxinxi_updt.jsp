...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updatePeisongyuanxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改配送员信息<input type="hidden" name="id" value="${peisongyuanxinxi.id}" /></td>
						</tr>
