...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.dingdanzhuangtai}</td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateDingdangenzong.do?id=${u.id }">签收</a><a class="btn btn-info btn-small" href="ddgzDetail.do?id=${u.id }" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
