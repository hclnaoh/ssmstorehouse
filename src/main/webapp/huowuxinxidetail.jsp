...
<jsp:include page="qttop.jsp"></jsp:include>
 <div  class="in_about">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>货物编号：</td><td width='39%'>${huowuxinxi.huowubianhao}</td><td  rowspan=5 align=center><a href=${huowuxinxi.shiwutu} target=_blank><img src=${huowuxinxi.shiwutu}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>货物名称：</td><td width='39%'>${huowuxinxi.huowumingcheng}</td></tr><tr>         <td width='11%' height=44>货物类型：</td><td width='39%'>${huowuxinxi.huowuleixing}</td></tr><tr>         <td width='11%' height=44>库存：</td><td width='39%'>${huowuxinxi.kucun}</td></tr><tr>         <td width='11%' height=44>价格：</td><td width='39%'>${huowuxinxi.jiage}</td></tr><tr>                           <td width='11%' height=100  >备注：</td><td width='39%' colspan=2 height=100 >${huowuxinxi.beizhu}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("huowuxinxi",id)){
	pli=pli+1;
     %>
                                   <tr>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回  class='hsgqiehuanshitu' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" /> <input type=button name=Submit53 class='hsgqiehuanshitu' value=出库订单 onClick="javascript:location.href='chukudingdanadd.jsp?id=<%=request.getParameter("id")%>';"/> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 class='hsgqiehuanshitu' onClick="javascript:hsgpinglun('huowuxinxi','<%=id%>')"/><input type=button name=Submit52 value=收藏 class='hsgqiehuanshitu' onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biaoj=hwxx&biao=huowuxinxi&ziduan=huowumingcheng';" /></td></tr>
