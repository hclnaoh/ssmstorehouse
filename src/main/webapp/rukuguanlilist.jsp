...
<form action="rkglList.do" name="myform" method="post" style="width:100%">
									...
									<input type="submit" value="查询" class='hsgqiehuanshitu' /> <input type="button" name="Submit2" value="切换视图" class='hsgqiehuanshitu' onClick="javascript:location.href='rkglListtp.do';" />
								</form>	
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.huowubianhao}</td>    <td>${u.huowumingcheng}</td>    <td>${u.huowuleixing}</td>    <td>${u.kucun}</td>    <td>${u.jiage}</td>    <td width='90'><a href='${u.shiwutu}' target='_blank'><img src='${u.shiwutu}' width=88 height=99 border=0 /></a></td>        
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="rkglDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="rkglList.do?page=1" >首页</a>
             <a href="rkglList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="rkglList.do?page=${page.page+1 }">下一页</a>
			<a href="rkglList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
