...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">入库管理列表</td>
						</tr>
					</table>
				</td>
			</tr>
  ...
  %>>
                             ...
                             <td>${u.huowubianhao}</td>    <td>${u.huowumingcheng}</td>    <td>${u.huowuleixing}</td>    <td>${u.kucun}</td>    <td>${u.rukushuliang}</td>    <td>${u.rukushijian}</td>        
                              ...
                              <td height="50" align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="rkglDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
