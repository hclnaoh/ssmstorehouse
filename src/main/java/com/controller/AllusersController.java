...
//	
   ...
   public String showAllusers(int id,ModelMap map,HttpSession session){
	   map.put("allusers", allusersServer.getById(id));
	   return "read";
   }
...
//	处理编辑
	...
	public String doUpdateAllusers(int id,ModelMap map,Allusers allusers){
		allusers=allusersServer.getById(id);
...
//	
	...
	public String updateAllusers(int id,ModelMap map,Allusers allusers){
		allusersServer.update(allusers);
		return "redirect:allusersList.do";
	}
//	所有List
...
//	分页查询
	...
	public String goodList(@RequestParam(value="page",required=false)String page,
		...
		int total=allusersServer.getCount(bmap);
		pageBean.setTotal(total);
		List<Allusers> list=allusersServer.getByPage(pmap);
...
//   分页模糊查询
	...
	public void quchongAllusers(Allusers allusers, HttpServletResponse response){
		   ...
		   System.out.println("username222==="+allusersServer.quchongAllusers(map));
		   JSONObject obj=new JSONObject();
		   if(allusersServer.quchongAllusers(map)!=null){
				 obj.put("info", "ng");
			   }else{
